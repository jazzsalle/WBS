...
export default function RiskTable({
  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white print:overflow-visible print:rounded-none print:border-0">
      <table className="w-full min-w-[1100px] text-left text-sm print:min-w-0 print:border-collapse print:text-xs">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {view.severity === null ? (
                        <span
                          ...
                          className="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-xs font-semibold text-slate-400"
                        >
                          판정 제외 {view.score}
                        </span>
                      ) : (
                        <span
                          ...
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-bold tabular-nums ${classes.badge}`}
                        >
