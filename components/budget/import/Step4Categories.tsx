  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2 text-xs text-grey-600">
        <label htmlFor="ministry-input" className="font-semibold text-grey-700">
          부처 (별칭 프리셋)
        </label>
        <input
          id="ministry-input"
      ...
      {skippedEntries.length > 0 && (
        <div>
          <button
            ...
            className="text-xs font-semibold text-grey-600 underline"
          >
            건너뛴 행 {skippedEntries.length}건 {showSkipped ? '접기' : '보기'}
          </button>
          {showSkipped && (
            <div className="mt-2">
              <p className="mb-1 text-[11px] text-grey-500">
      ...
      <section className="space-y-2 rounded-xl border border-grey-200 p-3">
        ...
        {saveProfile && !selectedProfile && (
          <label className="flex items-center gap-2 text-xs text-grey-600">
            ...
            <input
              ...
              className="flex-1 rounded-lg border border-grey-300 px-2 py-1"
            />
          </label>
        )}
      </section>
